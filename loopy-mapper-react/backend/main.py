...
from .routes import songs as songs_router
from .routes import drums as drums_router

app = FastAPI(
    title="Loopy Mapper API",
    version="1.0.0",
    description="MIDI dataset search, streaming, Song Object import/export, drum kit sample server, and Loopy Pro project generation",
)

app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:8765", "http://localhost:8766"],
