...
(function (root) {
  const actions = [
    ...
    { name: "Mute", id: "Mute", category: "clip", verified: true, aliases: ["mute"] },
    ...
    { name: "Adjust Parameter", id: "Track Parameter", category: "clip", verified: true, aliases: ["adjust parameter", "parameter", "track parameter", "volume", "pan"] },
